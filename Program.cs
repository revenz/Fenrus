    ...
    ReverseProxySettings reverseProxySettings1)
{
    webApplicationBuilder.Services.Configure<ForwardedHeadersOptions>(options =>
    {
        ...
        if (reverseProxySettings1.KnownIpv4Network.Enabled)
        {
            ...
            options.KnownIPNetworks.Add(CreateKnownNetwork(reverseProxySettings1.KnownIpv4Network.IpAddress,
        ...
        options.KnownIPNetworks.Add(CreateKnownNetwork(reverseProxySettings1.KnownIpv6Network.IpAddress, reverseProxySettings1.KnownIpv6Network.PrefixLength));
    });
}
...
/// </summary>
/// <remarks>
/// .NET 10 deprecated ForwardedHeadersOptions.KnownNetworks and the ASP.NET IPNetwork type
/// in favour of KnownIPNetworks and System.Net.IPNetwork. The framework type rejects a base
/// address that has any bit set beyond the prefix, so the address is masked here to keep
/// configurations such as 10.1.2.3/8 working.
/// </remarks>
