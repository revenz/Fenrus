...
class SearchEngineRouter extends FenrusRouter {
    ...
    init() {
        ...
        this.router.post('/:uid/default/:isDefault', async(req, res) => await this.safeAsync('setDefault', req, res));

        this.router.post('/:uid/status/:enabled', async(req, res) => await this.safeAsync('setEnabled', req, res));       
